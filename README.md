...
solutions involving payment infrastructure, banking APIs, crypto, custody, and compliance.

I'm also expanding into **AI Engineering**, exploring how to combine solid software
engineering practices with AI to build intelligent, production-ready applications.
...
**AI Engineering · AI-powered Applications · Python for AI**

My goal is to combine **Backend Engineering + AI** to build intelligent,
